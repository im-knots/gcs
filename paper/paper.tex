...
\newcommand{\sampleSizeFor80Power}{103}
...
\begin{itemize}
    \item \textbf{Outcome comparisons (4 groups)}: \powerOutcomeGroups{} power (requires n=\sampleSizeFor80Power{} for 80\% power)
...
\begin{itemize}
    \item Sample size: N=\totalConversations{} (\powerOutcomeGroups{} power, need n=\sampleSizeFor80Power{} for 80\%)
